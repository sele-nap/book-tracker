  ...
  return (
    <div className="mt-8 bg-dusk border border-mist/30 rounded-xl p-5">
      ...
      <textarea
        ...
        rows={5}
        className="w-full bg-bark border border-mist/40 rounded-lg px-3 py-2 text-cream placeholder:text-stone text-sm focus:border-mist/60 transition-colors resize-none"
      />
      {isDirty && (
        <button
          onClick={handleSave}
